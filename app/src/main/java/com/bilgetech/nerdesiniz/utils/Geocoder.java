...
public final class Geocoder
{
                                         ...
                                         int maxResults) throws IOException, LimitExceededException
    {
        ...
        final StringBuilder url = new StringBuilder("http://maps.googleapis.com/maps/api/geocode/json?sensor=true&latlng=");
        url.append(latitude);
        url.append(',');
    ...
    {
        final SharedPreferences p = SessionManager.getInstance(context).getPref();
